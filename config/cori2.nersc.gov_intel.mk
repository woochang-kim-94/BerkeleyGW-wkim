...
# module swap craype-haswell craype-mic-knl && module unload darshan && module load cray-hdf5-parallel && module swap intel intel/19.0.0.117 && export CRAYPE_LINK_TYPE=static
#
# Precompiler options

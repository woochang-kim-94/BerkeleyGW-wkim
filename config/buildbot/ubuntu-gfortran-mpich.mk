...
# running ubuntu 16.04 or 17.10, compiled with gfortran, mpich, and hdf5.
...
HDF5LIB      =  $(HDF5_LDIR)/libhdf5_mpichhl_fortran.a \
                $(HDF5_LDIR)/libhdf5_mpich_hl.a \
                $(HDF5_LDIR)/libhdf5_mpich_fortran.a \
                $(HDF5_LDIR)/libhdf5_mpich.a -lz -lsz -ldl
HDF5INCLUDE  = /usr/include/hdf5/mpich

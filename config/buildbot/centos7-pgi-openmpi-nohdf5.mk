...
# Centos7, pgi compiler + LAPACK + ScaLAPACK + openmpi, threaded
#
...
MATHFLAG  = -DUSESCALAPACK -DUNPACKED -DUSEFFTW3 -DUSEMR3 #-DUSEELPA -DUSEPRIMME
...
TESTSCRIPT = BGW_CHECK_FLAGS='-g binary' bash singularity.scr

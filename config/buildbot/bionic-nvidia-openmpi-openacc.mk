...
# Ubuntu 18.04 "Bionic", Nvidia HPC SDK 20.11 + FFTW3 + HDF5, threaded, CUDA 11.1, OpenACC
#
...
F90free = mpif90 -Mfree -mp=multicore -acc -gpu=cc75 -Mcuda=cuda11.1
LINK    = mpif90 -mp=multicore -acc -gpu=cc75 -Mcuda=cuda11.1
